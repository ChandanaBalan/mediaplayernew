...
import { getAllVideoHistoryApi,deleteHistoryVideoApi } from '../services/allApi'
              ...
              <tbody>
                {allHisVideo?.map((item, index)=>(
                  ...
                  <td className='text-center'>
                    <button className='btn btn-danger' onClick={()=>handleDelete(item?.id)}><FontAwesomeIcon icon={faTrash} />
                    </button></td>
                </tr>
                ))}
              </tbody>
...
:
      <h5 className='text-danger d-flex justify-content-center'>No Watch History</h5>}
